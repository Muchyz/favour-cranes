...
import { Plus, ShieldCheck, Truck, Handshake } from "lucide-react";
        ...
        return (
          <div key={group.category}>
            <div className="flex items-center gap-2 mb-4">
              <div className="flex items-center justify-center w-8 h-8 rounded-full bg-brandred/10">
                <GroupIcon size={16} className="text-brandred" />
              </div>
